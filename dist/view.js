...
function gup(e) {
    e = e.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
    var t = "[\\?&]" + e + "=([^&#]*)", n = new RegExp(t), r = n.exec(window.location.href);
    return null === r ? "" : r[1]
}
...
!function (e, t) {
    ...
    function x(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++) if ((o = e[p]) || 0 === o) if ("object" === me.type(o)) me.merge(f, o.nodeType ? [o] : o); else if (Ge.test(o)) {
        ...
        for (d.textContent = "", p = 0; o = f[p++];) if (r && me.inArray(o, r) > -1) i && i.push(o); else if (u = me.contains(o.ownerDocument, o), a = b(d.appendChild(o), "script"), u && y(a), n) for (c = 0; o = a[c++];) Ye.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function D(e, t) {
        ...
        if (1 === t.nodeType) {
            if (qe.hasData(e) && (o = qe.access(e), a = qe.set(t, o), u = o.events)) {
                ...
                for (i in u) for (n = 0, r = u[i].length; n < r; n++) me.event.add(t, i, u[i][n])
            }
    ...
    function $(e, t, r, i) {
        t = oe.apply([], t);
        var o, a, s, l, u, c, d = 0, f = e.length, p = f - 1, h = t[0], m = me.isFunction(h);
        ...
        if (f && (o = x(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            ...
            if (l) for (c = s[s.length - 1].ownerDocument, me.map(s, E), d = 0; d < l; d++) u = s[d], Ye.test(u.type || "") && !qe.access(u, "globalEval") && me.contains(c, u) && (u.src ? me._evalUrl && me._evalUrl(u.src) : n(u.textContent.replace(it, ""), c))
        }
        return e
    }
    ...
    function M(e, t, n) {
        var r, i = st(e), o = N(e, t, i), a = "border-box" === me.css(e, "boxSizing", !1, i);
    ...
    function U(e, t, n) {
        var r, i, o, a, s, l, u, c, d = "width" in t || "height" in t, f = this, p = {}, h = e.style,
            m = e.nodeType && We(e), g = qe.get(e, "fxshow");
        ...
        if ((l = !me.isEmptyObject(t)) || !me.isEmptyObject(p)) {
            ...
            for (r in p) l || (g ? "hidden" in g && (m = g.hidden) : g = qe.access(e, "fxshow", {display: u}), o && (g.hidden = !m), m && v([e], !0), f.done(function () {
    ...
    function z(e, t) {
        var n, r, i, o, a;
        for (n in e) if (r = me.camelCase(n), i = t[r], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = me.cssHooks[r]) && "expand" in a) {
    ...
    function X(e, t, n) {
        ...
        for (z(c, u.opts.specialEasing); o < a; o++) if (r = X.prefilters[o].call(u, e, c, u.opts)) return me.isFunction(r.stop) && (me._queueHooks(u.elem, u.opts.queue).stop = me.proxy(r.stop, r)), r;
    ...
    function G(e, t, n, r) {
        ...
        }); else if (n || "object" !== me.type(t)) r(e, t); else for (i in t) G(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var te = [], ne = e.document, re = Object.getPrototypeOf, ie = te.slice, oe = te.concat, ae = te.push,
        se = te.indexOf, le = {}, ue = le.toString, ce = le.hasOwnProperty, de = ce.toString, fe = de.call(Object),
        pe = {}, he = "3.2.1", me = function (e, t) {
            return new me.fn.init(e, t)
        }, ge = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ve = /^-ms-/, be = /-([a-z])/g, ye = function (e, t) {
    ...
    me.fn = me.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || me.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], r = e[t], a !== r && (u && r && (me.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && me.isPlainObject(n) ? n : {}, a[t] = me.extend(u, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }, me.extend({
    ...
    var xe = function (e) {
        function t(e, t, n, r) {
            var i, o, a, s, l, c, f, p = t && t.ownerDocument, h = t ? t.nodeType : 9;
        ...
        function f(e, t, n) {
            var r = t.dir, i = t.next, o = i || r, a = n && "parentNode" === o, s = R++;
            return t.first ? function (t, n, i) {
                ...
                } else for (; t = t[r];) if (1 === t.nodeType || a) if (d = t[M] || (t[M] = {}), c = d[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t; else {
        ...
        function g(e, t, n, i, o, a) {
            return i && !i[M] && (i = g(i)), o && !o[M] && (o = g(o, a)), r(function (r, a, s, l) {
                var u, c, d, f = [], p = [], g = a.length, v = r || h(t || "*", s.nodeType ? [s] : s, []),
                    b = !e || !r && t ? v : m(v, f, e, s, l), y = n ? o || (r ? e : g || i) ? [] : a : b;
                if (n && n(b, y, s, l), i) for (u = m(y, p), i(u, [], s, l), c = u.length; c--;) (d = u[c]) && (y[p[c]] = !(b[p[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function v(e) {
            for (var t, n, r, i = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = f(function (e) {
                ...
                return t = null, i
            }]; s < i; s++) if (n = w.relative[e[s].type]) c = [f(p(c), n)]; else {
                if (n = w.filter[e[s].type].apply(null, e[s].matches), n[M]) {
                    for (r = ++s; r < i && !w.relative[e[r].type]; r++) ;
                    return g(s > 1 && p(c), s > 1 && d(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(oe, "$1"), n, s < r && v(e.slice(s, r)), r < i && v(e = e.slice(r)), r < i && d(e))
                }
                c.push(n)
            }
            return p(c)
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, l, u) {
                var c, d, f, p = 0, h = "0", g = r && [], v = [], b = E, y = r || o && w.find.TAG("*", u),
                    x = I += null == b ? 1 : Math.random() || .1, T = y.length;
                ...
                if (p += h, i && h !== p) {
                    ...
                    if (r) {
                        if (p > 0) for (; h--;) g[h] || v[h] || (v[h] = V.call(l));
                        v = m(v)
                    }
        ...
        var y, x, w, T, C, _, k, j, E, D, S, $, A, N, L, O, q, P, H, M = "sizzle" + 1 * new Date, F = e.document, I = 0,
            R = 0, W = n(), B = n(), U = n(), z = function (e, t) {
                return e === t && (S = !0), 0
            ...
            me = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ge = /[+~]/,
            ve = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)", "ig"), be = function (e, t, n) {
                var r = "0x" + t - 65536;
                return r !== r || n ? t : r < 0 ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
            }, ye = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, xe = function (e, t) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && b) {
                                for (f = g, d = f[M] || (f[M] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === I && u[1], y = p && u[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (y = p = 0) || h.pop();) if (1 === f.nodeType && ++y && f === t) {
                                    c[e] = [I, p, y];
                                    break
                                }
                            } else if (b && (f = t, d = f[M] || (f[M] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === I && u[1], y = p), !1 === y) for (; (f = ++p && f && f[m] || (y = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && (d = f[M] || (f[M] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [I, y]), f !== t));) ;
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c, _ = t.tokenize = function (e, n) {
            ...
            var i, o, a, s, l, c = "function" == typeof e && e, f = !r && _(e = c.selector || e);
            if (n = n || [], 1 === f.length) {
                ...
                for (i = de.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]);) if ((l = w.find[s]) && (r = l(a.matches[0].replace(ve, be), ge.test(o[0].type) && u(t.parentNode) || t))) {
    ...
    var we = function (e, t, n) {
            ...
            return n
        }, Ce = me.expr.match.needsContext, _e = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
        ke = /^.[^:#\[\.,]*$/;
    ...
    (me.fn.init = function (e, t, n) {
        ...
        if (n = n || je, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof me ? t[0] : t, me.merge(this, me.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), _e.test(r[1]) && me.isPlainObject(t)) for (r in t) me.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
    ...
    me.fn.extend({
        has: function (e) {
            ...
            if (!Ce.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && me.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    me.Callbacks = function (e) {
        ...
        Deferred: function (t) {
            ...
            var t = arguments.length, n = t, r = Array(n), i = ie.call(arguments), o = me.Deferred(), a = function (e) {
                return function (n) {
    ...
    var qe = new f, Pe = new f, He = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Me = /[A-Z]/g;
    me.extend({
        hasData: function (e) {
    ...
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ie = new RegExp("^(?:([+-])=|)(" + Fe + ")([a-z%]*)$", "i"),
    ...
    var Qe = ne.documentElement, Je = /^key/, Ke = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Ze = /^([^.]*)(?:\.(.+)|)/;
    me.event = {
        global: {}, add: function (e, t, n, r, i) {
            var o, a, s, l, u, c, d, f, p, h, m, g = qe.get(e);
            if (g) for (n.handler && (o = n, n = o.handler, i = o.selector), i && me.find.matchesSelector(Qe, i), n.guid || (n.guid = me.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function (t) {
            ...
            if (g && (l = g.events)) {
                for (t = (t || "").match($e) || [""], u = t.length; u--;) if (s = Ze.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                ...
                } else for (p in l) me.event.remove(e, p + t[u], n, r, !0);
                me.isEmptyObject(l) && qe.remove(e, "handle events")
            }
        }, dispatch: function (e) {
            var t, n, r, i, o, a, s = me.event.fix(e), l = new Array(arguments.length),
                u = (qe.get(this, "events") || {})[s.type] || [], c = me.event.special[s.type] || {};
    ...
    me.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || me.isXMLDoc(e))) for (a = b(s), o = b(e), r = 0, i = o.length; r < i; r++) S(o[r], a[r]);
            if (t) if (n) for (o = o || b(e), a = a || b(s), r = 0, i = o.length; r < i; r++) D(o[r], a[r]); else D(e, s);
            return a = b(s, "script"), a.length > 0 && y(a, !l && b(e, "script")), s
        }, cleanData: function (e) {
            for (var t, n, r, i = me.event.special, o = 0; void 0 !== (n = e[o]); o++) if (Oe(n)) {
                if (t = n[qe.expando]) {
    ...
    var ot = /^margin/, at = new RegExp("^(" + Fe + ")(?!px)[a-z%]+$", "i"), st = function (t) {
    ...
    me.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = me.camelCase(t), l = ut.test(t), u = e.style;
        ...
        me.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i, o = r && st(e), a = r && H(e, t, r, "border-box" === me.css(e, "boxSizing", !1, o), o);
    ...
    me.Animation = me.extend(X, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = qe.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = me.timers,
                    a = r ? r.length : 0;
    ...
    me.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match($e) || []; n = this[l++];) if (i = V(n), r = 1 === n.nodeType && " " + Y(i) + " ") {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : me.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n) for (r = 0, i = me(this), o = e.match($e) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || (t = V(this), t && qe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : qe.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && (" " + Y(V(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var Tt = /\r/g;
    ...
    me.extend(me.event, {
        trigger: function (t, n, r, i) {
            var o, a, s, l, u, c, d, f = [r || ne], p = ce.call(t, "type") ? t.type : t,
            ...
            if (a = s = r = r || ne, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(p + me.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[me.expando] ? t : new me.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : me.makeArray(n, [t]), d = me.event.special[p] || {}, i || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                ...
                for (o = 0; (a = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || p, c = (qe.get(a, "events") || {})[t.type] && qe.get(a, "handle"), c && c.apply(a, n), (c = u && a[u]) && c.apply && Oe(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    }), pe.focusin = "onfocusin" in e, pe.focusin || me.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
    ...
    var _t = e.location, kt = me.now(), jt = /\?/;
    ...
    var At = /%20/g, Nt = /#.*$/, Lt = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        qt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, Ht = /^\/\//, Mt = {},
        Ft = {}, It = "*/".concat("*"), Rt = ne.createElement("a");
    Rt.href = _t.href, me.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, a, s, l, u, c, d, f, p, h = me.ajaxSetup({}, n), m = h.context || h,
                g = h.context && (m.nodeType || m.jquery) ? me(m) : me.event, v = me.Deferred(),
                b = me.Callbacks("once memory"), y = h.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
    ...
    pe.cors = !!Bt && "withCredentials" in Bt, pe.ajax = Bt = !!Bt, me.ajaxTransport(function (t) {
        ...
        if (pe.cors || Bt && !t.crossDomain) return {
            send: function (i, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Wt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {binary: s.response} : {text: s.responseText}, s.getAllResponseHeaders()))
                    }
    ...
    me.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
            var r, i, o, a, s, l, u, c = me.css(e, "position"), d = me(e), f = {};
    ...
    var e = null, t = "item", n = "separator", r = function () {
        ...
        var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], t = {x: e.clientX, y: e.clientY};
        ...
        var n = s(e), r = n.x, i = n.y, o = {width: window.innerWidth, height: window.innerHeight},
    ...
    return {ITEM: t, SEPARATOR: n, show: c, visible: d, close: f}
})
...
build = {}, build.iconic = function (e) {
    ...
    var t = "", n = lychee.retinize(e.thumbs[0]), r = n.path, i = n.isPhoto;
    ...
    var t = "", n = lychee.retinize(e.thumbUrl), r = n.path;
...
}, api = {path: "php/index.php", onError: null}, api.post = function (e, t, n) {
    loadingBar.show(), t = $.extend({function: e}, t);
    var r = function (e) {
    ...
    $.ajax({type: "POST", url: api.path, data: t, dataType: "json", success: r, error: i})
}, header = {_dom: $(".header")}, header.dom = function (e) {
    ...
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Untitled",
        t = header.dom(".header__title"), n = lychee.html(_templateObject16, e, build.iconic("caret-bottom"));
    return t.html(n), !0
...
}, sidebar = {_dom: $(".sidebar"), types: {DEFAULT: 0, TAGS: 1}, createStructure: {}}, sidebar.dom = function (e) {
    ...
    var t = !1, n = e.takestamp + e.make + e.model + e.shutter + e.aperture + e.focal + e.iso, r = {}, i = "";
    ...
    return r.basics = {
        ...
        rows: [{title: "Title", value: e.title, editable: t}, {
            title: "Uploaded",
            value: e.sysdate
        }, {title: "Description", value: e.description, editable: t}]
    }, r.image = {
        title: "Image",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Size", value: e.size}, {title: "Format", value: e.type}, {
            title: "Resolution",
        ...
        title: "Camera",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Captured", value: e.takedate}, {title: "Make", value: e.make}, {
            title: "Type/Model",
            value: e.model
        }, {title: "Shutter Speed", value: e.shutter}, {title: "Aperture", value: e.aperture}, {
            title: "Focal Length",
            value: e.focal
        }, {title: "ISO", value: e.iso}]
    } : {}, r.sharing = {
        title: "Sharing",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Public", value: i}]
    ...
    return n.basics = {
        title: "Basics",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Title", value: e.title, editable: t}, {title: "Description", value: e.description, editable: t}]
    }, n.album = {
        title: "Album",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Created", value: e.sysdate}, {title: "Images", value: e.num}]
    }, n.share = {
        title: "Share",
        type: sidebar.types.DEFAULT,
        rows: [{title: "Public", value: r}, {title: "Hidden", value: i}, {
            title: "Downloadable",
            value: o
...
contextMenu.sharePhoto = function (e, t) {
    var n = [{
        ...
        title: build.iconic("link-intact") + "Direct Link", fn: function () {
...
var loadPhotoInfo = function (e) {
    var t = {photoID: e, albumID: 0, password: ""};
    api.post("Photo::get", t, function (e) {
        ...
        var t = sidebar.createStructure.photo(e), n = sidebar.render(t);
        sidebar.dom(".sidebar__wrapper").html(n), sidebar.bind()
    })
}, error = function (e, t, n) {
    console.error({description: e, params: t, response: n}), loadingBar.show("error", e)
};